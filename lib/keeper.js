 ...
 *
 * @param  {Object} params
 * @param  {Object} [params.client=null]  a redis client
 * @method Keeper
 */
function Keeper(params) {
    ...
    if (client) keeper.setClient(client);
}
...
Keeper.prototype.getClient = function() {
    return this.client;
};

Keeper.prototype.setClient = function(client) {
    var keeper = this;
    keeper.client = client;
    util.each(keeper.models, function(model) {
...
Keeper.defineModelClass = defineModelClass;
Keeper.defineModelClasses = defineModelClasses;
...
defineModelClasses([{
    ...
    customizeProxy: function(Proxy) {
        ...
        if (fields) {
            Proxy.fields = fields;
            Proxy.prototype.fields = fields;  // eslint-disable-line no-extend-native
        }
    },
}, {
    type: 'LIST',
